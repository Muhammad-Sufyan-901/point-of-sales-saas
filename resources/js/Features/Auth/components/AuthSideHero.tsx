...
export function AuthSideHero(): React.JSX.Element {
  return (
    <Box className="relative hidden w-[60%] flex-col justify-center overflow-hidden bg-linear-to-br from-slate-950 via-slate-900 to-blue-950 px-16 py-12 text-white lg:flex">
      <Box className="absolute top-12 left-16 flex items-center space-x-3">
        <BanknoteArrowUp className="h-8 w-8 text-blue-400 drop-shadow-md" />
        <Link href="/">
      ...
      <Box className="relative z-10 mt-8 w-full max-w-2xl">
        ...
        >
          ...
          <Box as="br" />
          <Text as="span" className="text-[64px] font-extrabold text-blue-400">
